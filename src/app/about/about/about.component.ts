...
export class AboutComponent implements OnInit {
  ...
  constructor() {
    this.members = [
      ...
      { image: 'assets/profile_pic/Ieva.jpg', name: 'Ieva Lundin', git: 'https://github.com/eiwulia', mail: 'ievalundin@gmail.com', linkedin: 'https://www.linkedin.com/in/ieva-lundin-bba94a171/' }
    ];
  }
  ngOnInit() {
  }
